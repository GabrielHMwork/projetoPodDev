# DevMentor Brasil - Landing Page PodDev com HTML e CSS
...
Você precisa desenvolver a landing page do podcast chamado "PodDev" que seria para um podcast sobre tecnologia seguindo todo modelo, design e componentes fornecidos pela plataforma DevMentor.
...
- Deve criar uma landing page seguindo todo layout fornecido.
- A página deve ser responsiva em diferentes tamanhos como Desktop, Tablet e celular, seguind o layout passado.

Quer algum apoio no desafio? [Junte-se à nossa comunidade](https://www.devmentor.com.br/comunidade) e faça perguntas no canal.

## Onde encontrar tudo

No site você baixou os arquivos iniciais para começar o projeto com HTML, CSS e todas imagens e componentes necessários.
...
## Posso criar usando algum framework?
- Sim você pode criar usando sua tecnologia favorita sem problema, seja HTML, CSS, React JS, Angular, Vuejs ou qualquer outra que deseja praticar.
